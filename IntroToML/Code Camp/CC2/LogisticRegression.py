# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 00:29:47 2020
...
train_x = pd.read_csv("C:/Users/Shravya/OneDrive/Desktop/marketing_training.csv",index_col=0)
train_x
train_y = train_x['responded']
train_y.hist()
train_x.drop('responded',axis=1,inplace=True)
train_x
test_x = pd.read_csv("C:/Users/Shravya/OneDrive/Desktop/marketing_test.csv",index_col=0)
test_x
